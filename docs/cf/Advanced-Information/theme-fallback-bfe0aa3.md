...
You can define a fallback theme for a custom theme. For more information, see [Defining a Fallback Theme](../Create-and-Edit-Themes-and-Theme-Sets/Customizing-Themes-in-the-Editor/defining-a-fallback-theme-af0f4e6.md). If the fallback is itself a custom theme, it can define its own fallback, creating a chain. As this chain is processed, any SAP themes extended by these custom themes are collected as "preferred SAP themes".
