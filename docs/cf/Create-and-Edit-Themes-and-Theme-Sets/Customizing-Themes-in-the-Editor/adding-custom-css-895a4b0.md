...
-   You have the `CustomCssEditor (sap-theming)` role as described in [Permissions](../../Advanced-Information/permissions-c3fdb69.md).
...
> -   Check whether you can achieve your target design using [Expert Theming](expert-theming-7b01607.md). Use this approach whenever possible.
...
Suppose you have created the palette parameters `myBlue` and `myGreen` as described in [Reusing Color Parameters](reusing-color-parameters-16ed37f.md), and you want to use them in the otherwise theme-independent CSS of your own custom SAPUI5 control `com.example.MyButton`.
