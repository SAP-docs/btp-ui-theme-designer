...
> ### Note:  
> You can also export themes from the *Theme* menu of the editor under *Theme* \> *Export...*. For more information, see [Customizing Themes in the Editor](Customizing-Themes-in-the-Editor/customizing-themes-in-the-editor-aa4b233.md).
