...
The structure of a custom theme mirrors that of SAP themes. For more details, see [Overview of SAP Theming Content](overview-of-sap-theming-content-91ebfe2.md). Custom themes contain only the delta information—meaning only the changes you made compared to the base SAP theme are saved. When a custom theme is compiled, both your customizations and the base SAP theme are combined to generate the final theme.
