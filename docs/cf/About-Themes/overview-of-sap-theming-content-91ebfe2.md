...
The reference palette and parameter dependencies may vary between themes. For details, review [Theme Parameter Dependencies](../Advanced-Information/theme-parameter-dependencies-18d80b4.md).
